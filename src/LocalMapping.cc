...
{
    //cout << "InitializeIMU  id: " << mpCurrentKeyFrame->mnId << endl;
    //cout << "id: " << mpCurrentKeyFrame->mnId << endl << "bg" << mbg << endl << "ba" << mba << endl;

    if (mbResetRequested)
        return;
    //cout << "InitializeIMU  1" << endl;
    float minTime;
    int nMinKF;
    if (mbMonocular)
    {
    ...
    //cout << "mpAtlas->KeyFramesInMap's size:" << mpAtlas->KeyFramesInMap() << endl;
    if(mpAtlas->KeyFramesInMap()<nMinKF)
        return;
    //cout << "InitializeIMU  2" << endl;
    ...
    //cout << "InitializeIMU  3" << endl;
    mFirstTs=vpKF.front()->mTimeStamp;
    if(mpCurrentKeyFrame->mTimeStamp-mFirstTs<minTime)
        return;

    //cout << "InitializeIMU  4" << endl;
    bInitializing = true;
    ...
    else
    {
        ...
        //cout << "===========================" << endl << "bg" << mbg << endl << "ba" << mba << endl;
    }
    ...
    //cout << "id1: " << mpCurrentKeyFrame->mnId << endl << "scale: " << mScale << endl << "bg" << mbg << endl << "ba" << mba << endl;
    std::chrono::steady_clock::time_point t0 = std::chrono::steady_clock::now();
    Optimizer::InertialOptimization(mpAtlas->GetCurrentMap(), mRwg, mScale, mbg, mba, mbMonocular, infoInertial, false, false, priorG, priorA);

    //cout << "id2: " << mpCurrentKeyFrame->mnId << endl << "scale: " << mScale << endl << "bg" << mbg << endl << "ba" << mba << endl;
